...
public:
	...
	virtual HFONT2D		CreateFont(const char* name, int width, int height, float char_width, float char_height, int rows, int columns);
	virtual GEN_RESULT	DrawText(HFONT2D hFont, const char* text, float x, float y);
